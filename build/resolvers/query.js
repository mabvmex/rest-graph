    ...
    Query: {
        seasonsList(_, __, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.seasons.getSeasons()
                    .then((data) => data.MRData.SeasonTable.Seasons);
            });
        },
        racesByYear(_, { year }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.races.getYear(year)
                    .then((data) => data.MRData.RaceTable.Races);
            });
        },
        raceSelect(_, { year, round }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.races.getYearRound(year, round)
                    .then((data) => data.MRData.RaceTable.Races[0]);
            });
        },
        historyDrivers(_, { pageElements, page }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.drivers.getDrivers(pageElements, page)
                    .then((data) => data.MRData.DriverTable.Drivers);
            });
        },
        driversYear(_, { year }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.drivers.getDriversByYear(year)
                    .then((data) => data.MRData.DriverTable.Drivers);
            });
        },
        driversYearAndRound(_, { year, round }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.drivers.getDriversByYearAndRound(year, round)
                    .then((data) => data.MRData.DriverTable.Drivers);
            });
        },
        driverSelect(_, { id }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.drivers.getDriver(id)
                    .then((data) => data.MRData.DriverTable.Drivers[0]);
            });
        },
        driverStanding(_, { year }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.drivers.getDriverStanding(year)
                    .then((data) => data.MRData.StandingsTable.StandingsLists[0].DriverStandings);
            });
        },
        historyCircuitos(_, { pageElements, page }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.circuits.getCircuits(pageElements, page)
                    .then((data) => data.MRData.CircuitTable.Circuits);
            });
        },
        circuitSelect(_, { id }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.circuits.getCircuit(id)
